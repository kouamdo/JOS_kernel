...
.LM42:
	...
	jmp	.L20
.L23:
	.stabn	68,0,66,.LM43-.LFBB3
.LM43:
	movq	%rbp, panicstr(%rip)
	.stabn	68,0,69,.LM44-.LFBB3
.LM44:
#APP
# 69 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,71,.LM45-.LFBB3
.LM45:
#NO_APP
	leaq	224(%rsp), %rax
...
.LFE2:
	.size	_panic, .-_panic
	.stabs	"ap:(0,6)=(0,7)=(0,8)=ar(0,9)=r(0,9);0;-1;;0;0;(0,10)=xs__va_list_tag:",128,0,0,8
...
.LM59:
	leaq	.LC6(%rip), %rdi
	.stabn	68,0,89,.LM60-.LFBB4
.LM60:
	movq	%rax, 24(%rsp)
	.stabn	68,0,90,.LM61-.LFBB4
.LM61:
	xorl	%eax, %eax
	.stabn	68,0,89,.LM62-.LFBB4
.LM62:
	movl	$48, 12(%rsp)
	.stabn	68,0,90,.LM63-.LFBB4
.LM63:
	call	cprintf@PLT
	.stabn	68,0,91,.LM64-.LFBB4
.LM64:
	leaq	8(%rsp), %rsi
	movq	%rbp, %rdi
	call	vcprintf@PLT
